...
class qsiprep_panpipeline(panpipeline):
    ...
    def __init__(self,labels_dict,pipeline_dir, participant_label,name='qsiprep_panpipeline',createGraph=True,LOGGER=None,execution={},analysis_level = "participant", participant_project=None):
