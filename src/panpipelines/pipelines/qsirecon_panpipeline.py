...
import os
import glob
import panpipelines.workflows.qsirecon_workflow as panworkflow

TARGET_ANALYSIS_LEVEL=["participant"]
class qsirecon_panpipeline(panpipeline):

    def __init__(self,labels_dict,pipeline_dir, participant_label,name='qsirecon_panpipeline',createGraph=True,LOGGER=None,execution={},analysis_level = "participant", participant_project=None,participant_session=None):
