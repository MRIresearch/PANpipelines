...
import os
import glob
import panpipelines.workflows.collatecsv_workflow as panworkflow

TARGET_ANALYSIS_LEVEL=["participant"]
class collatecsv_panpipeline(panpipeline):

    def __init__(self,labels_dict,pipeline_dir, participant_label, name='collatecsv_panpipeline',createGraph=True,LOGGER=None,execution={},analysis_level = "participant", participant_project=None,participant_session=None):
