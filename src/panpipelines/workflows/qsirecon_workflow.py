...
import panpipelines.nodes.qsirecon as qsirecon
...
def create(name, wf_base_dir,labels_dict,createGraph=True,execution={},LOGGER=None):
    ...
    qsirecon_node = qsirecon.create(labels_dict,input_dir=qsiprep_input_dir,LOGGER=LOGGER)

    pan_workflow.add_nodes([qsirecon_node])
