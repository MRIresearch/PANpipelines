...
PIPELINES="--pipelines basilmeasures_arterial_native_pvcorr_gm_maskchem basilmeasures_arterial_native_pvcorr_wm_maskchem collate_subject_arterial collategroup_arterial"
