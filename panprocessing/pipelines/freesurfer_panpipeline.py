...
from panprocessing.pipelines.panpipeline import *
import os
import glob
...
class freesurfer_panpipeline(panpipeline):
    ...
    def __init__(self,labels_dict,pipeline_dir, participant_label, name='freesurfer_panpipeline',createGraph=True,logging=None,execution={}):

        super().__init__(labels_dict,pipeline_dir, participant_label,name,createGraph,logging,execution)

    def proc(self):
        import panprocessing.workflows.freesurfer_workflow as panworkflow
