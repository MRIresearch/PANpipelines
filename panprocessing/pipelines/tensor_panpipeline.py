...
class tensor_panpipeline(panpipeline):
    ...
    def __init__(self,labels_dict,pipeline_dir, participant_label, name='tensor_panpipeline',createGraph=True,logging=None,execution={}):

        super().__init__(labels_dict,pipeline_dir, participant_label,name,createGraph,logging,execution)

    def proc(self):
        import panprocessing.workflows.tensor_workflow as panworkflow
