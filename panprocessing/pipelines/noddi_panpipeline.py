...
class noddi_panpipeline(panpipeline):
    ...
    def __init__(self,labels_dict,pipeline_dir, participant_label, name='noddi_panpipeline',createGraph=True,logging=None,execution={}):

        super().__init__(labels_dict,pipeline_dir, participant_label,name,createGraph,logging,execution)

    def proc(self):
        import panprocessing.workflows.noddi_workflow as panworkflow
