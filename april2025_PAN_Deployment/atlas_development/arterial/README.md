...
### Processing steps for Level 1 Atlas
...
5. `ArterialAtlasLabels.txt` renamed to `res-01_atlas-Arterial_dseg.tsv` and `res-02_atlas-Arterial_dseg.tsv` to create BIDS compliant labels

---

### Processing steps for Level 2 Atlas
