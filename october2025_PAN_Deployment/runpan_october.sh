...
source $ROOTDIR/venvs/pan_october2025_env/bin/activate
CURRDIR=$(readlink -f $PWD)

# 2. Change PYTHON=python3 if this is required to access python version.
PYTHON=python
PKG_DIR=$ROOTDIR/venvs/pan_october2025_env/lib/python3.11/site-packages/
...
CONFIG=$ROOTDIR/config/pan.config.oct2025
